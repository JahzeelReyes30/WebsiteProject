  ...
  return (
    <section id="about" className="py-16">
      <div className="mx-auto max-w-[1080px] px-6">
        <h2 className="mb-8 text-center text-3xl font-bold text-[#0b3d3a]">About Us</h2>
        <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] md:items-start">
          <div className="space-y-4 text-[#4a5a58]">
            <p>
              ...
              follow healthcare-inspired cleaning protocols — hospital-grade disinfectants,
              color-coded tools to prevent cross-contamination, and a room-by-room checklist
          ...
          <ul className="grid gap-4">
            {POINTS.map((point) => (
              <li key={point.title} className="rounded-lg bg-[#e6f6f4] p-4">
                <strong className="mb-1 block text-[#0b3d3a]">{point.title}</strong>
                <span className="text-sm text-[#4a5a58]">{point.body}</span>
              </li>
            ))}
          </ul>
        </div>
